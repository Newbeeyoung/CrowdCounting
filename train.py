...
train_path = './data/formatted_trainval/mall_dataset/perspective_img/rgb_train'
train_gt_path = './data/formatted_trainval/mall_dataset/rgb_train_den'
...
test_path = './data/formatted_trainval/mall_dataset/perspective_img/rgb_test'
test_gt_path = './data/formatted_trainval/mall_dataset/rgb_val_den'
...
model_path = './final_models/mcnn_mall_58_ms.h5'
...
data_loader_test = ImageDataLoader(test_path, test_gt_path, shuffle=False, gt_downsample=True, pre_load=True)
